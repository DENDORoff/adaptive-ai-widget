...
namespace App\Filament\Resources\UnionEducationDocuments;

use App\Filament\Resources\UnionEducationDocuments\Pages;
...
class UnionEducationDocumentsResource extends Resource
{
    protected static ?string $model = UnionEducationDocument::class;

    protected static ?string $navigationLabel = 'Профсоюзное обучение';
    protected static ?string $modelLabel = 'Документ по профобучению';
    protected static ?string $pluralModelLabel = 'Документы по профобучению';
    ...
    {
        return [
            'index' => Pages\ListUnionEducationDocuments::route('/'),
            'create' => Pages\CreateUnionEducationDocuments::route('/create'),
            'edit' => Pages\EditUnionEducationDocuments::route('/{record}/edit'),
        ];
    }
